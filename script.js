...
const suspects = [
  ...
  {
    name: "Nina Faye",
    backstory: "A retired pilot with decades of experience, traveling to accept a lifetime achievement award. Despite her accolades, recent financial troubles have cast a shadow over her otherwise stellar reputation.",
    clues: [
      "A maintenance manual with circled notes was found in her seat pocket.",
      "A faint smell of aviation fuel clung to her jacket.",
      "A note addressed to 'Captain' was found in the stowaway’s belongings.",
      "Her flight logbook had unauthorized entries."
    ]
  },
  {
    name: "Chloe Sharpe",
  ...
  {
    name: "Jasmine Hayes",
    backstory: "A wealthy art dealer returning from a successful auction in Europe. Her shady dealings and reputation for smuggling antiquities make her a controversial figure in elite circles.",
    clues: [
      "A receipt for 'custom adjustments' to her seat was found in her wallet.",
      "Her gloves had traces of paint matching the cockpit door.",
      "Witnesses saw her carrying a suspiciously large bag when boarding.",
